class Webscan < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/thetillhoff/webscan/releases/download/#{version}/webscan_darwin_arm64"
      sha256 "c622300fbc6a5d3661cfa67b7564ca0018544212a66d075f849709a16dcf8db8"
    end

    on_intel do
      url "https://github.com/thetillhoff/webscan/releases/download/#{version}/webscan_darwin_amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/thetillhoff/webscan/releases/download/#{version}/webscan_linux_arm64"
      sha256 "64aa9393c56f517140c5e8aeda39b6a66b646d82a89f0e87d88d1cc4337921f0"
    end

    on_intel do
      url "https://github.com/thetillhoff/webscan/releases/download/#{version}/webscan_linux_amd64"
